    ...
    >
      ...
      <div
        ...
        className={`absolute top-0 left-0 bottom-0 w-2 -ml-1 cursor-col-resize z-30 transition-colors ${
          isResizing ? 'bg-[#111111]' : 'hover:bg-[#111111]/40'
        }`}
      ...
      <div className="h-10 border-b border-[#D8D5CC] px-3 flex items-center justify-between text-[10px] font-bold bg-[#F6F4EE] shrink-0">
        <span className="truncate max-w-[200px] text-[#111111] uppercase">
...
/>
          ...
          <div className="flex-1 p-6 flex flex-col items-center justify-center text-center space-y-4">
            <div className="border-2 border-dashed border-[#D8D5CC] p-8 w-full bg-[#F6F4EE] flex flex-col items-center justify-center space-y-4">
              <div className="w-12 h-12 bg-[#111111] text-[#FCF9F2] flex items-center justify-center font-bold text-xl">
                +
              </div>
              <div className="space-y-1">
                ...
                <span className="text-[9px] text-[#767571] block leading-relaxed">
                  CARREGUE UM FICHEIRO PDF PARA VISUALIZAR AQUI LADO A LADO COM O SEU CADERNO
                </span>
              </div>

              <label className="mt-2 inline-block bg-[#111111] hover:bg-[#31312C] text-[#FCF9F2] px-5 py-2.5 text-[10px] font-bold uppercase tracking-wider cursor-pointer transition-colors border border-[#111111]">
